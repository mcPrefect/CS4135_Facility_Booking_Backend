package com.facilitybooking.approvalservice.config;
...
public class RabbitMQConfig {
    ...
    @Value("${rabbitmq.queues.booking-created:approval.booking.created.queue}")
    private String bookingCreatedQueue;

    @Value("${rabbitmq.queues.dlq:approval.events.dlq}")
    ...
    public Binding bookingCreatedBinding(Queue bookingCreatedQueue, TopicExchange bookingEventsExchange) {
        return BindingBuilder.bind(bookingCreatedQueue).to(bookingEventsExchange).with("booking.bookingcreated");
    }
